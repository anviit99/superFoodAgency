...
<div id="footer-wp">
    <div id="foot-body">
        <div class="wp-inner clearfix">
            <div class="block" id="info-company">
                <h3 class="title"><img src="public/images/logo.png"></h3>
                <p class="desc">SUPERFOOD luôn cung cấp luôn là sản phẩm tươi mới và đảm bảo ATTT, chính sách ưu đãi cực lớn cho khách hàng có thẻ thành viên.</p>
                <div id="payment">
                    <div class="thumb">
            ...
            <div class="block menu-ft" id="info-shop">
                ...
                <ul class="list-item">
                    <li>
                        <p>64 - Vĩnh Hưng - Hà Nội</p>
                    </li>
                    <li>
                        <p>0347.092.927 - 0989.989.989</p>
                    </li>
                    <li>
                        <p>superfood@gmail.com</p>
                    </li>
                </ul>
            </div>
    ...
    <div id="foot-bot">
        <div class="wp-inner">
            <p id="copyright">© Bản quyền thuộc về chủ cửa hàng An vi</p>
        </div>
    </div>
</div>
</div>
