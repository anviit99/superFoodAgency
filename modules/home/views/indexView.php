                ...
                <div class="section-detail">
                    <ul class="list-item clearfix">
                        <li>
                            ...
                            <img class="img_tw" src="public/images/layout/circle-1.png" alt="">
                            <h3 class="title">Mua sắm online</h3>
                        ...
                        <li>
                            ...
                            <img class="img_tw" src="public/images/layout/circle-2.png" alt="">
                        ...
                        <li>
                            ...
                            <img class="img_tw" src="public/images/layout/circle-3.png" alt="">
                            <h3 class="title">Hỗ trợ đổi trả</h3>
                            <p class="desc">1900.0000</p>
                        </li>
                        <li>
                            <div class="thumb">
                            ...
                            <img class="img_tw" src="public/images/layout/circle-4.png" alt="">
