...
function pagination_catAction()
{
    ...
    if (isset($_POST['price'])) {
        ...
        if ($price == 1) {
            $query .= 'AND `product_price_new` < 10000 ';
        }
        if ($price == 2) {
            $query .= 'AND `product_price_new`  >= 10000 AND `product_price_new` < 20000 ';
        }
        if ($price == 3) {
            $query .= 'AND `product_price_new`  >= 20000 AND `product_price_new` < 50000 ';
        }
        if ($price == 4) {
            $query .= 'AND `product_price_new`  >= 50000 AND `product_price_new` < 100000 ';
        }
        if ($price == 5) {
            $query .= 'AND `product_price_new`  >= 100000 ';
        }
    }
    # filter by brand
